...
抽象思维的流程：`概念-命题-推理`。  
`概念`，人们交流时用不同语言的不同词汇定义它，苹果=apple，悲伤的感觉=sad，所指的概念是一样的。如果概念上就不一致（比如双方辩论时对于某一事物的“定义”就有争议），思考得出的结论就不同，则人们之间无法相互交流，抽象思维也就失去了它的一部分意义-在条件有限无法形象思维时，人们基于抽象思维得出结论，互相交流，在抗辩的基础上互相印证，使得人类认知进步。  
`命题`是串连概念得出的一个推论，比如“3+3=9”“下雨不打伞会淋湿”。  
`推理`基本方法有归纳推理、演绎推理。    
...
逻辑学继续演化为`演绎逻辑`又称`形式逻辑`，侧重于从形式上进行推理论证，除三段论外还有联言推理、选言推理等方式。`联言推理`又称`联言支`，几个小命题互相印证得到一个大命题，支命题之间的关系为“与”，大命题对则支命题都对，大命题错则不能马上确定哪个支命题是错的。`选言推理`支命题之间关系为“或”。     
