...
抽象思维的流程：概念-命题-推理。抽象思维的基础`概念`，人们交流时用不同语言的不同词汇定义它，苹果=apple，悲伤的感觉=sad，所指的概念是一样的。如果概念上就不一致（比如双方辩论时对于某一事物的“定义”就有争议），思考得出的结论就不同，则人们之间无法相互交流，抽象思维也就失去了它的一部分意义-在条件有限无法形象思维时，人们基于抽象思维得出结论，互相交流，在抗辩的基础上互相印证，使得人类认知进步。`命题`是串连概念得出的一个推论，比如“3+3=9”“下雨不打伞会淋湿”。
西方逻辑学的起源：苏格拉底的三段论，大前提-小前提-结论  
